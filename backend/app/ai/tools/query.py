...
- **업종으로 건물 찾기**(「병원 건물」·「카페 많은 건물」) → master.localdata_permit 에서 업체를 찾아
  건물에 잇는다. 대장 주용도(main_use)는 **통째로 그 용도인 건물**만이라 대부분을 놓친다
  (성수동2가 의료시설 2동 vs 실제 병원이 든 42지번). SQL 은 skill("SQL예제") 에 있다
