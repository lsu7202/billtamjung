...
const SECTIONS: Sec[] = [
  ...
  },
  {
    ...
    slides: [
      ...
      { t: "알아두면 강력한 조건", rows: [
        ["용적률 여유분", "법정 − 현재 용적률. 증축·신축 여지가 남은 건물을 찾을 때(예: 여유 100% 이상)"],
  ...
  },
  {
    ...
    slides: [
      { t: "요약 화면", img: "02-리포트요약.png", cap: "① 추정가 · ② 가격 비교 · ③ 예상수익률 · ④ 리포트 만들기",
        rows: [
  ...
  },
  {
    ...
    slides: [
      ...
      { t: "결과물", img: "07-리포트1.png", rows: [
        ["구성", "표지 · 핵심 요약 · 기본정보 · 가격분석 · 근거 사례 · 공시지가 · 임대현황 · 수익률 · 투자유형 · 미래가치"],
