...
export const GROUPS: Group[] = [
  { t: "입지정보",
    ...
    body: [M("유동인구", ["미지정", "매우높음", "높음", "보통", "낮음", "매우낮음"])] },
  { t: "건물정보",
    reps: [
  ...
  { t: "상세정보",
    reps: [M("건물용도", ["미지정", "수익률", "신축용", "사옥용", "리모델링용"])],
    body: [
      SM("등급", ["미지정", "매우좋음", "좋음", "나쁨", "매우나쁨"]), SM("입지", ["미지정", "매우좋음", "좋음", "나쁨", "매우나쁨"]),
      M("명도", ["미지정", "완료", "가능", "불가", "일부", "조건부"]),
      M("용도변경", ["미지정", "나대지(주차장)", "근생", "상가주택", "다가구주택", "다세대주택", "가능", "불가", "협의가능", "조건부"]),
      M("멸실", ["미지정", "불가", "협조가능", "잔금전멸실", "나대지(주차장)", "협의가능", "조건부"]),
    ] },
  { t: "공시지가·실거래·광고",
    reps: [
  ...
  { t: "업무",
    reps: [M("진행상태", ["준비중", "진행중", "철회", "가격제시", "매각"]), M("소유자타입", ["미지정", "개인", "법인"])],
    body: [
      M("담당자", ["미지정", "이승욱", "박실장", "김대리"]),
      M("긴급도", ["미지정", "매우급함", "급함", "보통", "여유", "안팔아도됨"]),
      M("관계", ["미지정", "건물주/법인대표", "관리자", "친인척", "부동산", "기타"]),
      M("협조도", ["미지정", "협조적", "보통", "비협조적"]), M("친절도", ["미지정", "친절", "보통", "불친절"]),
      X("소유자명", "소유자명"), X("매물번호", "매물번호"),
      S("접수일", { min: 1970, max: 2026, unit: "", inf: true, inflo: true, handle: "left", ge: "부터", le: "까지", ticks: "2000,2015" }),
      T("매수의향서", ["미지정", "원함", "원치않음"]), T("전화번호", ["있음", "없음"]),
